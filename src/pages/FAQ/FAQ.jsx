  ...
  return (
    <React.Fragment>
        ...
        <div className="head-intro">
          ...
          <p>Got a question? If you don't see your question here, reach us on the <a href="./ourteam.html">contact page</a></p>
        </div>
        ...
        <div className="hidden-content" id="hidden-content-1">
          <p>Lorem ipsum dolor sit amet.<br /> <br /> Hic illum vitae iusto impedit aut reprehenderit recusandae maxime earum? Cumque omnis eum beatae nostrum? Neque sapiente molestiae deleniti impedit, eveniet atque?</p>
        ...
        <div className="frequent-questions">
          <h2>Are there answers to questions on cloud computing or is it just restricted to web development?</h2>
