      ...
      <div id='main' style={loaded ? openMain : closeMain}>
        ...
        <header>
          ...
          <div className='search'>
            <img
              src='../IMAGES/ANSWER PAGE ICONS/search-icon.png'
          ...
          <div className='notification'>
            <img src='../IMAGES/ANSWER PAGE ICONS/notification.png' alt />
        ...
        <section className='askquestion-main'>
          ...
          <div className='body'>
            ...
            <div className='askquestion-icons'>
              ...
              <div className='textsize'>
                ...
                <svg
                  ...
                  xmlns='http://www.w3.org/2000/svg'>
                  <path
                    d='M5 5.9998L0 0.999804L0.7 0.299805L5 4.5998L9.3 0.299805L10 0.999804L5 5.9998Z'
                    fill='#212529'
                  />
                </svg>
              </div>
              <div className='alignment'>
                <svg
                  ...
                  xmlns='http://www.w3.org/2000/svg'>
                  <path
                    d='M4.5 1.75H13.25V3H4.5V1.75ZM4.5 5.5H10.75V6.75H4.5V5.5ZM4.5 9.25H13.25V10.5H4.5V9.25ZM4.5 13H10.75V14.25H4.5V13ZM0.75 0.5H2V15.5H0.75V0.5Z'
                    fill='#212529'
                  />
                </svg>
                <svg
              ...
              <div className='lists'>
                <svg
                  ...
                  xmlns='http://www.w3.org/2000/svg'>
                  <path
                    d='M2.375 4.5C3.41053 4.5 4.25 3.66053 4.25 2.625C4.25 1.58947 3.41053 0.75 2.375 0.75C1.33947 0.75 0.5 1.58947 0.5 2.625C0.5 3.66053 1.33947 4.5 2.375 4.5Z'
                    fill='#212529'
                  />
                  <path
                    d='M2.375 13.25C3.41053 13.25 4.25 12.4105 4.25 11.375C4.25 10.3395 3.41053 9.5 2.375 9.5C1.33947 9.5 0.5 10.3395 0.5 11.375C0.5 12.4105 1.33947 13.25 2.375 13.25Z'
                    fill='#212529'
                  />
                  <path
                    d='M8 10.75H16.75V12H8V10.75ZM8 2H16.75V3.25H8V2Z'
                    fill='#212529'
                  />
                </svg>
                <svg
                  ...
                  xmlns='http://www.w3.org/2000/svg'>
                  <path
                    d='M8 11.75H16.75V13H8V11.75ZM8 3H16.75V4.25H8V3ZM3 5.5V0.5H1.75V1.125H0.5V2.375H1.75V5.5H0.5V6.75H4.25V5.5H3ZM4.25 15.5H0.5V13C0.5 12.6685 0.631696 12.3505 0.866116 12.1161C1.10054 11.8817 1.41848 11.75 1.75 11.75H3V10.5H0.5V9.25H3C3.33152 9.25 3.64946 9.3817 3.88388 9.61612C4.1183 9.85054 4.25 10.1685 4.25 10.5V11.75C4.25 12.0815 4.1183 12.3995 3.88388 12.6339C3.64946 12.8683 3.33152 13 3 13H1.75V14.25H4.25V15.5Z'
                    fill='#212529'
                  />
                </svg>
              </div>
              <div className='textadditions'>
                ...
                <svg
                  ...
                  xmlns='http://www.w3.org/2000/svg'>
                  <path
                    d='M19.375 7L15 11.375L14.1187 10.4937L17.6063 7L14.1187 3.50625L15 2.625L19.375 7ZM0.625 7L5 2.625L5.88125 3.50625L2.39375 7L5.88125 10.4937L5 11.375L0.625 7ZM7.7625 12.9275L11.025 0.75L12.2325 1.07313L8.97 13.25L7.7625 12.9275Z'
                    fill='#212529'
                  />
                </svg>
                <svg
